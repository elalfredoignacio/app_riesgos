...
# la ejecución la junto toda en una función porque quiero que es lo que haga cuando aprieto el botón de ejecutar en la app
def ejecutar_modelos(df):
    ...
    # recordar que los pickle tienen que estar en el mismo directorio que el script
